package com.wincor.recruit.controller;
...
import com.wincor.recruit.pojo.Enterprise;
import com.wincor.recruit.service.EnterpriseService;
...
public class EnterpriseController {
	...
	public Result hotlist(){
		List<Enterprise> list =enterpriseService.hotList("1");  //数据库中1为热门，这里写死
